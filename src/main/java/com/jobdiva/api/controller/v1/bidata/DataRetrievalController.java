package com.jobdiva.api.controller.v1.bidata;
...
@Api(value = "Data Retrieval API", description = "REST API Used For Data Retrieval")
public class DataRetrievalController extends AbstractJobDivaController {
	...
	public IBiData ResumeDetail(//
			...
			@RequestParam(required = true) String resumeId, //
			//
			@ApiParam(value = "Alternate Format", required = false) //
			@RequestParam(required = false) Boolean alternateFormat //
	//
		...
		JobDivaSession jobDivaSession = getJobDivaSession();
		//
		String[] parameters = new String[] { resumeId };
		//
		//
	...
	public IBiData TimesheetDetail(//
			@ApiParam(value = "Internal Timesheet Id or External Timesheet Id", required = true) //
	...
	@RequestMapping(value = "/ExpenseDetail", method = RequestMethod.GET, produces = "application/json")
	public IBiData ExpenseDetail(//
			@ApiParam(value = "Internal Expense Id or External Expense Id", required = true) //
	...
	//
		...
		JobDivaSession jobDivaSession = getJobDivaSession();
		//
		String[] parameters = isExternal != null ? new String[] { expenseId.toString(), Boolean.toString(isExternal) } : new String[] { expenseId.toString() };
		//
		//
		return biDataService.getBIData(jobDivaSession, "Expense Detail", null, null, parameters, alternateFormat);
		//
	}
	...
	@RequestMapping(value = "/OpenJobsList", method = RequestMethod.GET, produces = "application/json")
	public IBiData OpenJobsList(//
			//
			//
			@ApiParam(value = "Alternate Format", required = false) //
			@RequestParam(required = false) Boolean alternateFormat //
	...
	//
		...
		//
		return biDataService.getBIData(jobDivaSession, "Open Jobs List", null, null, parameters, alternateFormat);
		//
	}
	...
	//
		...
		//
		return biDataService.getBIData(jobDivaSession, "New Approved Timesheets", fromDate, toDate, parameters, alternateFormat);
		//
	}
	...
	@RequestMapping(value = { "/CandidateHotlistList" }, method = { RequestMethod.GET }, produces = { "application/json" })
	public IBiData CandidateHotlistList(//
			//
			@ApiParam(value = "Alternate Format", required = false) //
			@RequestParam(required = false) Boolean alternateFormat) //
			//
		...
		String[] parameters = new String[] {};
		//
		return this.biDataService.getBIData(jobDivaSession, "Candidate Hotlist List", null, null, parameters, alternateFormat);
		//
	}
}

...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
	...
	/**
	 * Handles JobDivaException. Created to encapsulate errors with more detail
	 * than javax.persistence.JobDivaException.
	 *
	 * @param ex
	 *            the JobDivaException
	 * @return the ApiError object
	 */
	@SuppressWarnings("deprecation")
	@ExceptionHandler(JobDivaException.class)
	protected ResponseEntity<Object> handleEntityNotFound(JobDivaException ex) {
		ApiError apiError = new ApiError(HttpStatus.METHOD_FAILURE);
